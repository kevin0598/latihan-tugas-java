...
public class menu implements receipt {
	...
	String list[][] = { { "1", "Makanan", "Nasi Goreng", "15000" }, { "2", "Makanan", "Mie Goreng", "15000" },
			{ "3", "Makanan", "Capjay Goreng", "15000" }, { "4", "Makanan", "Ikan Goreng", "15000" },
			{ "5", "Makanan", "Ayam Goreng", "15000" } };

	String list2[][] = { { "1", "Minuman", "Jus Jeruk", "8000" }, { "2", "Minuman", "Jus Melon", "8000" },
			{ "3", "Minuman", "Jus Alpukat", "8000" }, { "4", "Minuman", "Es Teh", "5000" },
			{ "5", "Minuman", "Air Putih", "3000" } };

	String list3[][] = { { "1", "Paket A", "Nasi Goreng + Jus Jeruk", "20000" },
		...
		if (b == 0) {
			...
			while (a <= b) {
				for (int i = 0; i < pilihan.size(); i++) {
					...
					System.out.println(a + " " + pilihan.get(i).nama + " " + pilihan.get(i).harga2 + " QTY= "
							+ pilihan.get(i).jumlah + " Total = " + totalharga);
					a++;
				}
				System.out.println("");
